...
.onebot-webqq-webqq.is-frosted .onebot-webqq-webqq__group-announcement {
  ...
  it('styles WebQQ chat history search as an inline expanding field with calendar and result popovers', () => {
    ...
    expect(ruleBodyIncluding('.webqq-message-search-date-popover', webqqInteractionsStyle)).toContain('width: 248px')
    ...
    expect(calendarSelectorButton).toContain('font-size: 13px')
