...
describe('webqq observer view', () => {
  ...
  it('searches the current WebQQ conversation history and jumps to a result', () => {
    ...
    expect(webqqView).toContain('@click="openMessageSearch($event)"')
    expect(webqqView).toContain('rememberFloatingPanelAnchor(event)')
    ...
    expect(webqqMessageSearchPage).toContain('<Teleport to="body">')
    expect(webqqMessageSearchPage).toContain('webqq-secondary-page onebot-webqq-webqq__portal-page webqq-message-search-page')
