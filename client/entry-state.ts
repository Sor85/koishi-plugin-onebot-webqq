...
import { capsule, capsuleAnchor } from './capsule/state'
import {
...
// 入口锚点走同一条边：观察窗要跟着小胶囊落位，但不能反向 import 小胶囊领域。
export { capsuleAnchor }
export type { CapsuleAnchor } from './capsule/state'
