                ...
                <ContextMenuTrigger as-child :disabled="selectionMode">
                  ...
                  >
                    <span class="onebot-webqq-webqq__message-avatar-wrap">
                      <img v-if="message.senderAvatar" class="onebot-webqq-webqq__message-avatar" :src="withProxy(message.senderAvatar)" :alt="message.senderName">
                      <span v-else class="onebot-webqq-webqq__message-avatar is-fallback" aria-hidden="true">{{ message.senderName.slice(0, 1) }}</span>
